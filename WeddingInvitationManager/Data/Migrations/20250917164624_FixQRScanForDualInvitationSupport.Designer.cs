...
namespace WeddingInvitationManager.Migrations
{
    ...
    [Migration("20250917164624_FixQRScanForDualInvitationSupport")]
    partial class FixQRScanForDualInvitationSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeddingInvitationManager.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WeddingInvitationManager.Models.Invitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WeddingInvitationManager.Models.InvitationTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("QRPositionX")
                        .HasColumnType("integer");

                    b.Property<int>("QRPositionY")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WeddingInvitationManager.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WeddingInvitationManager.Models.Invitation", b =>
                {
                    b.HasOne("WeddingInvitationManager.Models.Contact", "Contact")
