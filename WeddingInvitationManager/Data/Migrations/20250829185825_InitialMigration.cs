        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationLink = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QRPositionX = table.Column<int>(type: "integer", nullable: false),
                    QRPositionY = table.Column<int>(type: "integer", nullable: false),
                    QRSize = table.Column<int>(type: "integer", nullable: false),
                    IsDefault = table.Column<bool>(type: "boolean", nullable: false),
                    IsVipTemplate = table.Column<bool>(type: "boolean", nullable: false),
                    EventId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedByGuard = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScannedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_EventId_PhoneNumber",
                table: "Contacts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QRScans_InvitationId",
                table: "QRScans",
                column: "InvitationId");

            migrationBuilder.CreateIndex(
                name: "IX_QRScans_ScannedAt",
                table: "QRScans",
                column: "ScannedAt");
        }
